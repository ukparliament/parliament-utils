...
RSpec.describe Parliament::Utils::Helpers::BusinessItemGroupingHelper do

  it 'has a class called BusinessItemGroupedObject' do
    expect(Parliament::Utils::Helpers::BusinessItemGroupingHelper::BusinessItemGroupedObject).to be_a(Class)
  end

  describe '#group' do
    context 'with no data' do
      it 'returns an empty array' do
        expect(Parliament::Utils::Helpers::BusinessItemGroupingHelper.group([], :grouping, :name)).to eq([])
      end
    end
    ...
    context 'with data' do
      ...
      it 'returns an array of grouped, ungrouped and unknown data' do
        expect(Parliament::Utils::Helpers::BusinessItemGroupingHelper.group(data, :date).length).to eq(5)
      end
    end
  end
  ...
  describe '#create_sorted_array' do
    context 'with no data' do
      it 'returns an empty array' do
        expect(Parliament::Utils::Helpers::BusinessItemGroupingHelper.create_sorted_array({})).to eq([])
      end
    end
    ...
    context 'with data' do
      ...
      it 'returns an array of grouped objects' do
        expect(Parliament::Utils::Helpers::BusinessItemGroupingHelper.create_sorted_array(data_hash).length).to eq(4)
      end
    end
  end
  ...
  describe '#create_grouped_objects' do
    before(:each) do
      @grouped = Parliament::Utils::Helpers::BusinessItemGroupingHelper.create_grouped_objects(data_hash, DateTime.new(2017, 4, 8))
    end
    ...
    context 'with data' do
      ...
      it 'of BusinessItemGroupingHelper::BusinessItemGroupedObject class' do
        expect(@grouped[0].class).to eq(Parliament::Utils::Helpers::BusinessItemGroupingHelper::BusinessItemGroupedObject)
      end
