...
RSpec.describe Parliament::Utils::Helpers::RoleGroupingHelper do

  it 'has a class called RoleGroupedObject' do
    expect(Parliament::Utils::Helpers::RoleGroupingHelper::RoleGroupedObject).to be_a(Class)
  end

  describe '#group' do
    context 'with no data' do
      it 'returns an empty array' do
        expect(Parliament::Utils::Helpers::RoleGroupingHelper.group([], :grouping, :name)).to eq([])
      end
    end
    ...
    context 'with data' do
      ...
      it 'returns an array of grouped, ungrouped and unknown data' do
        expect(Parliament::Utils::Helpers::RoleGroupingHelper.group(data, :grouping, :name).length).to eq(4)
      end
    end
  end
  ...
  describe '#create_sorted_array' do
    context 'with no data' do
      it 'returns an empty array' do
        expect(Parliament::Utils::Helpers::RoleGroupingHelper.create_sorted_array({})).to eq([])
      end
    end
    ...
    context 'with data' do
      ...
      it 'returns an array of grouped objects' do
        expect(Parliament::Utils::Helpers::RoleGroupingHelper.create_sorted_array(data_hash).length).to eq(4)
      end
    end
  end
  ...
  describe '#create_grouped_objects' do
    context 'with data' do
      ...
      it 'returns a non-empty array' do
        grouped = Parliament::Utils::Helpers::RoleGroupingHelper.create_grouped_objects(data_hash, 'apple')
        expect(grouped.length).to eq 1
      end

      it 'of RoleGroupingHelper::RoleGroupedObject class' do
        grouped = Parliament::Utils::Helpers::RoleGroupingHelper.create_grouped_objects(data_hash, 'apple')
        expect(grouped[0].class).to eq(Parliament::Utils::Helpers::RoleGroupingHelper::RoleGroupedObject)
      end
